...
fig4rev.savefig('Figure4.png',dpi=dpi,bbox_inches='tight',pad_inches=0.05)
#fig4rev.savefig('Figure4revision.png',dpi=dpi,bbox_inches='tight',pad_inches=0.05) #0.02 ,bbox_inches='tight',pad_inches=0.05
fig4rev.savefig('Figure4.eps',bbox_inches='tight')
plt.close()
############## FIGURE FOR PUBLICATION 
...
figre.savefig('figre.png',dpi=dpi)
plt.close()
...
plt.tight_layout(pad=0.05)
figpub1.savefig('publication1.png',dpi=dpi)
figpub1.savefig('final4.png',dpi=dpi,bbox_inches='tight',pad_inches=0.02)
plt.close()
